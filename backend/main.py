...
from api.routes import a2a, artifacts, auth, mcp, projects, skills, agents, workflows, settings as settings_routes, sessions
...
app.include_router(artifacts.router, prefix=f"{settings.API_V1_STR}", tags=["Artifacts"])
